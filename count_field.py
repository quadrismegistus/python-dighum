...
for filename in os.listdir(folder):
    ...
    counts = count_words(words) # goes from list to dictionary
    ...
    for word in field:
        count = counts.get(word, 0) # this is a function all dictionaries have that will allow you to set a default value for a key
        tf = (count/numwords) * 1000
        line = [filename, word, str(count), str(tf)] # this defines what we want in each line as part of a list
